...
# Feature Generation
master_df_folder = get_latest_folder("latest", base_path + "data/gc/train_output")

preproc_config.feature["train_pso_data_dir"] = master_df_folder + "/pso_filters_run"
preproc_config.feature["train_master_data_dir"] = master_df_folder
